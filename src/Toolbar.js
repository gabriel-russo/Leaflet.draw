    ...
    if (this.options.externalButtons) {
      ...
      */
      ...
      if (!this._actionButtons.length) {
        this._actionButtons = this.options.externalButtons.actions || null;
      }
  ...
  removeToolbar() {
    ...
    for (let handlerId in this._modes) {
      if (Object.prototype.hasOwnProperty.call(this._modes, handlerId)) {
        ...
        if (this._modes[handlerId].button) {
          this._disposeButton(
    ...
    if (this.options.externalButtons) {
      ...
      if (this._actionButtons) {
        ...
        this._activeMode.actions.forEach(action => {
          ...
          if (action.enabled) {
            if (Object.hasOwnProperty.call(this._actionButtons, action.type)) { // Open possibilities to add just some actions buttons
    ...
    if (this.options.externalButtons) {
      ...
      if (this._actionButtons) {
        this._activeMode.actions.forEach(action => {
          ...
          if (action.enabled) {
            if (Object.hasOwnProperty.call(this._actionButtons, action.type)) {
